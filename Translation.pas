...
const
   ...
   LNK_CPTN_MENUITEM_LST_N3_N1 = 'LNK_CPTN_MENUITEM_LST_N3_N1';
   LNK_CPTN_MENUITEM_LST_N3_N2 = 'LNK_CPTN_MENUITEM_LST_N3_N2';
   ...
   LNK_CPTN_MENUITEM_LST_N17 = 'LNK_CPTN_MENUITEM_LST_N17';
   ...
   LNK_CPTN_MENUITEM_LST_N16_1 = 'LNK_CPTN_MENUITEM_LST_N16_1';
   LNK_CPTN_MENUITEM_LST_N16_2 = 'LNK_CPTN_MENUITEM_LST_N16_2';
...
if aLanguageID = EN_US then
 begin
  ...
  if StringID  = GLOBAL_CPTN_BTN_BTN10 then
     Result := 'Save changes';
  if StringID  = GLOBAL_TEXT_DIAG1 then
     Result := 'Select executable file';
  ...
  if StringID  = LNK_CPTN_MENUITEM_LST_N3_N1 then
     Result := 'From file';
  if StringID  = LNK_CPTN_MENUITEM_LST_N3_N2 then
     Result := 'From folder';
  ...
  if StringID  = LNK_CPTN_MENUITEM_LST_N12 then
     Result := 'Folders to list';
  if StringID  = LNK_CPTN_MENUITEM_LST_N17 then
     Result := 'Personal folders to the toolbar';
  ...
  if StringID  = LNK_CPTN_MENUITEM_LST_N15 then
     Result := 'Properties';
  if StringID  = LNK_CPTN_MENUITEM_LST_N16_1 then
     Result := 'Add to toolbar';
  if StringID  = LNK_CPTN_MENUITEM_LST_N16_2 then
     Result := 'Remove from toolbar';
...
if aLanguageID = RU_RU then
 begin
  ...
  if StringID  = LNK_CPTN_MENUITEM_LST_N11 then
     Result := 'Приложения в список';
  if StringID  = LNK_CPTN_MENUITEM_LST_N12 then
     Result := 'Папки в список';
  if StringID  = LNK_CPTN_MENUITEM_LST_N17 then
     Result := 'Личные папки на панели инструментов';
  if StringID  = LNK_CPTN_MENUITEM_LST_N13 then
  ...
  if StringID  = LNK_CPTN_MENUITEM_LST_N15 then
     Result := 'Свойства';
  if StringID  = LNK_CPTN_MENUITEM_LST_N16_1 then
     Result := 'Добавить на панель инструментов';
  if StringID  = LNK_CPTN_MENUITEM_LST_N16_2 then
     Result := 'Удалить с панели инструментов';
  if StringID  = LNK_GLOBAL_TEXT_MSG1 then
...
if aLanguageID = RO_RO then
 begin
  ...
  if StringID  = LNK_CPTN_MENUITEM_LST_N11 then
     Result := 'Aplicațiile în listă';
  if StringID  = LNK_CPTN_MENUITEM_LST_N12 then
     Result := 'Folderele în listă';
  if StringID  = LNK_CPTN_MENUITEM_LST_N17 then
     Result := 'Dosare personale în bara de instrumente';
  if StringID  = LNK_CPTN_MENUITEM_LST_N13 then
  ...
  if StringID  = LNK_CPTN_MENUITEM_LST_N15 then
     Result := 'Proprietăți';
  if StringID  = LNK_CPTN_MENUITEM_LST_N16_1 then
     Result := 'Adăugați în bara de instrumente';
  if StringID  = LNK_CPTN_MENUITEM_LST_N16_2 then
     Result := 'Eliminați din bara de instrumente';
  if StringID  = LNK_GLOBAL_TEXT_MSG1 then
     Result := 'Selectați un fișier sau folder';
  if StringID  = LNK_GLOBAL_TEXT_MSG2 then
